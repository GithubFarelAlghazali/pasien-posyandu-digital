    ...
    <div className="bg-gray-50 min-h-screen pb-24">
      ...
      <div className="p-6">
        ...
        <div className="bg-white rounded-3xl p-6 border-2 border-pink-50 shadow-sm flex items-center justify-between mb-8">
           ...
           <button className="bg-secondary-pink text-white px-6 py-2 rounded-full font-bold text-sm shadow-md active:scale-95 transition-transform">
              Mulai
           </button>
        </div>
        ...
        <motion.div 
           ...
           className="relative rounded-[40px] overflow-hidden mb-8 h-64 shadow-2xl group cursor-pointer"
        >
           <img 
            src="https://images.unsplash.com/photo-1540331548438-50bad0c4fbbd?q=80&w=2574&auto=format&fit=crop" 
            alt="MPASI Game" 
           ...
           <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-8 flex flex-col justify-end">
              ...
              <h4 className="text-2xl font-black text-white italic mb-2">Simulasi Gizi MPASI</h4>
        ...
        <div className="flex justify-between px-2 pb-8">
           {[
             ...
             <div key={idx} className="flex flex-col items-center gap-3 w-16">
                <div className={`w-14 h-14 rounded-full flex items-center justify-center shadow-inner ${badge.active ? 'bg-pink-100 border-2 border-secondary-pink/20' : 'bg-gray-100 grayscale'}`}>
                   {badge.icon}
                </div>
                <span className={`text-[10px] text-center font-bold leading-tight ${badge.active ? 'text-gray-800' : 'text-gray-400'}`}>
                   {badge.label}
                </span>
             </div>
           ))}
