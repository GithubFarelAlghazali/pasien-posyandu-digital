			...
			<div className="p-6">
				...
				<div className="space-y-6">
					...
					<div className="grid grid-cols-2 gap-4">
						...
						<motion.button whileTap={{ scale: 0.95 }} className="bg-pink-100/50 rounded-[32px] p-8 flex flex-col items-center justify-center gap-4 transition-all hover:bg-pink-100">
